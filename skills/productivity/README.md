...
- **[teach](./teach/SKILL.md)** — Teach a skill over multiple sessions in the current-directory teaching workspace using self-contained HTML lessons and references.
...
- **[wait-what](./wait-what/SKILL.md)** — Re-pitch a message in ASD-STE100 Simplified Technical English using the active logical-context vocabulary.
